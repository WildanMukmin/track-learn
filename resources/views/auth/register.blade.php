    ...
    <div class="min-h-screen flex">
        ...
        <div class="hidden lg:flex lg:w-1/2 gradient-bg items-center justify-center p-12">
            <div class="text-white text-center">
                ...
                <h2 class="text-4xl font-bold mb-4">Bergabung dengan TrackLearn</h2>
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-5">
                    ...
                    <div class="flex items-start">
                        ...
                        <label for="terms" class="ml-2 block text-sm text-gray-700">
                            Saya setuju dengan <a href="#" class="text-purple-600 hover:text-purple-700 font-semibold">Syarat & Ketentuan</a> serta <a href="#" class="text-purple-600 hover:text-purple-700 font-semibold">Kebijakan Privasi</a>
                        </label>
                    </div>
