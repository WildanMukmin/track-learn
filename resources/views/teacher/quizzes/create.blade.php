                        ...
                        <div id="questions-container" class="space-y-6">
                            ...
                            <div class="question-item border border-gray-300 rounded-lg p-4">
                                <div class="flex justify-between items-center mb-3">
                                    ...
                                    <button type="button"
                                        class="remove-question text-red-600 hover:underline hidden">Hapus</button>
                                </div>

                                <label class="block font-medium mb-1">Teks Pertanyaan</label>
                                <input type="text" name="questions[0][question_text]"
                                    class="w-full border rounded-lg p-2 mb-3" placeholder="Tulis pertanyaan..." required>

                                <div class="grid grid-cols-2 gap-3">
                                    <div>
                                        <label class="block text-sm font-medium">Opsi A</label>
                                        <input type="text" name="questions[0][option_a]"
                                            class="w-full border rounded-lg p-2" required>
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium">Opsi B</label>
                                        <input type="text" name="questions[0][option_b]"
                                            class="w-full border rounded-lg p-2" required>
                                    </div>
                                    <div>
                                ...
                                <div class="mt-3">
                                    ...
                                    <select name="questions[0][correct_answer]" class="border rounded-lg p-2 w-1/3"
                                        required>
