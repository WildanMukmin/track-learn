        ...
        <main class="flex-1 bg-gray-50 flex flex-col h-full overflow-hidden">
            <div class="p-6">
                ...
                <form action="{{ route('teacher.quizzes.update', $quiz->id) }}" method="POST"
                    class="bg-white p-6 rounded-lg shadow max-h-[80vh] overflow-y-auto">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="title" class="w-full border rounded-lg p-2" value="{{ $quiz->title }}"
                            required>
                    </div>
